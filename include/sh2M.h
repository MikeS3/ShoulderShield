...
/**
 * @brief Get the latest sensor event for a specific SH2 instance
 * @param pInstance Pointer to the SH2 instance
 * @param pEvent Pointer to a sensor event struct to receive data
 * @return SH2_OK if an event is available, SH2_ERR_NO_DATA otherwise
 */
